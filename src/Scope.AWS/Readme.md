...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Scope.AWS*):
...
Execute unit tests
```
    cd "Scope.AWS/test/Scope.AWS.Tests"
    dotnet test
```

Deploy application
```
    cd "Scope.AWS/src/Scope.AWS"
